import{o as Y,f as B,a as F,r as Z}from"./assets/quote-api-localStorage-ClLQ3NEF.js";import{a as K,i as y}from"./assets/vendor-D2ogNlHo.js";const $=document.getElementById("footerSubscribeForm");if($){let e=function(o){return/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(o)},a=function(o){y.success({title:"Success",message:o,position:"topRight",timeout:5e3})},n=function(o){y.error({title:"Error",message:o,position:"topRight",timeout:5e3})};const s=$.querySelector('input[name="email"]'),t=$.querySelector('button[type="submit"]');$.addEventListener("submit",i);async function i(o){o.preventDefault();const h=s.value.trim();if(!e(h)){n("Invalid email address");return}try{t.disabled=!0;const d=await K.post("https://your-energy.b.goit.study/api/subscription",{email:h},{headers:{"Content-Type":"application/json"}});d.status===201&&(a(d.data.message),$.reset())}catch(d){d.response?n(d.response.data.message||"Subscription failed"):n("Network error. Please try again.")}finally{t.disabled=!1}}}const b=document.getElementById("scroll-top"),_=()=>{window.scrollTo({top:0,behavior:"smooth"})},j=()=>{const s=window.scrollY,t=document.querySelector("footer");if(s>window.innerHeight)if(b.classList.add("scroll-show"),t){const i=t.getBoundingClientRect();if(i.top<window.innerHeight){const e=window.innerHeight-i.top;b.style.bottom=e+200+"px"}else b.style.bottom="30px"}else b.style.bottom="30px";else b.classList.remove("scroll-show"),b.style.bottom="30px"};window.addEventListener("scroll",j);window.addEventListener("resize",j);b.addEventListener("click",_);const g="/project-17112025/assets/icons-not-min-CqnbliU1.svg";function O(s,t){const i=s.map(({filter:e,imgURL:a,name:n})=>`
  ...
  `,V=h+d+T;i.innerHTML=V}function A(s,t,i){const e=s.map(a=>`
          <li class="filters-list-item ${t===a?"filters-list-item-active":""}" data-option="${a}"><p>${a}</p></li>
      `).join("");i.innerHTML=e}function q(s){if(!s)return;let t=s.querySelector(".local-loader-wrapper");t||(t=document.createElement("div"),t.classList.add("local-loader-wrapper"),t.innerHTML=`
      <div class="hypnotic"></div>
    `,s.style.position="relative",s.appendChild(t)),t.classList.remove("hidden")}function M(s){if(!s)return;const t=s.querySelector(".local-loader-wrapper");t&&t.classList.add("hidden")}const C=["Muscles","Body parts","Equipment"],G=375,D=document.documentElement.clientWidth<=G,N=document.querySelector("span.slash"),z=document.querySelector("p.current-category"),J=document.querySelector("p.warning"),H=document.querySelector("ul.filters-list"),k=document.querySelector("ul.block-categories-list"),x=document.querySelector("ul.exercises-list"),l=document.querySelector("ul.pagination-controls-list"),E=document.querySelector("form.search-form"),U=E.querySelector(".search-input"),S=document.querySelector("button.clear-btn"),m=document.getElementById("categories-section"),X=document.querySelector("a.nav-link");X.classList.add("nav-link--active");let v=C[0],u="",f="",c=1,L=1,Q=D?9:12,r=1,p=1,R=D?8:10;E.addEventListener("input",s=>{f=s.target.value,f.length?S.classList.remove("visually-hidden"):S.classList.add("visually-hidden")});E.addEventListener("submit",async s=>{s.preventDefault(),q(m);try{const t=await B(v,u,f,r,R),{results:i,page:e,totalPages:a}=t;p=a,r=e,l.innerHTML="",P(i,x),w(p,r,l)}catch(t){y.error({icon:"",position:"topRight",message:t.message})}finally{M(m)}});S.addEventListener("click",async()=>{f="",U.value="",S.classList.add("visually-hidden"),P(results,x),w(p,r,l),I()});async function I(){k.innerHTML="",x.innerHTML="",l.innerHTML="",q(m);try{const s=await F(v,c,Q),{results:t,page:i,totalPages:e}=s;L=e,c=i,O(t,k),w(L,c,l)}catch(s){J.classList.remove("visually-hidden"),y.error({icon:"",position:"topRight",message:s.message})}finally{M(m)}}H.addEventListener("click",tt);function tt(s){const t=s.target.closest(".filters-list-item");t&&(v=t.dataset.option,I(),results.length>0&&A(C,v,H),E.classList.add("visually-hidden"),f="",u="",U.value="",z.textContent=u,N.classList.add("visually-hidden"))}async function et(s){const t=s.target.closest(".categories-item");if(t){q(m),u=t.dataset.name;try{const i=await B(v,u,f,r,R),{results:e,page:a,totalPages:n}=i;p=n,r=a,k.innerHTML="",l.innerHTML="",P(e,x),e.length>0&&(w(p,r,l),E.classList.remove("visually-hidden")),z.textContent=u,N.classList.remove("visually-hidden")}catch(i){y.error({icon:"",position:"topRight",message:i.message})}finally{M(m)}}}async function st(s){const t=s.target.closest("button[data-page]");if(t){q(m),console.log(t.dataset.page);try{if(u){switch(t.dataset.page){case"beg":r=1;break;case"prev":r--;break;case"next":r++;break;case"end":r=p;break;default:r=parseInt(t.dataset.page,10)}const i=await B(v,u,f,r,R),{results:e,page:a,totalPages:n}=i;p=n,r=a,P(e,x),w(p,r,l)}else{switch(t.dataset.page){case"beg":c=1;break;case"prev":c--;break;case"next":c++;break;case"end":c=L;break;default:c=parseInt(t.dataset.page,10)}const i=await F(v,c,Q),{results:e,page:a,totalPages:n}=i;L=n,c=a,O(e,k),w(L,c,l)}}catch(i){y.error({icon:"",position:"topRight",message:i.message})}finally{M(m)}}}A(C,v,H);I();k.addEventListener("click",et);l.addEventListener("click",st);document.addEventListener("DOMContentLoaded",Z);
