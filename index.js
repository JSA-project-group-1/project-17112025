import{o as W,f as B,a as F,r as Y}from"./assets/quote-api-localStorage-BOl9OyTg.js";import{a as Z,i as y}from"./assets/vendor-D2ogNlHo.js";const $=document.getElementById("footerSubscribeForm");if($){let e=function(o){return/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/.test(o)},a=function(o){y.success({title:"Success",message:o,position:"topRight",timeout:5e3})},n=function(o){y.error({title:"Error",message:o,position:"topRight",timeout:5e3})};const s=$.querySelector('input[name="email"]'),t=$.querySelector('button[type="submit"]');$.addEventListener("submit",i);async function i(o){o.preventDefault();const h=s.value.trim();if(!e(h)){n("Invalid email address");return}try{t.disabled=!0;const d=await Z.post("https://your-energy.b.goit.study/api/subscription",{email:h},{headers:{"Content-Type":"application/json"}});d.status===201&&(a(d.data.message),$.reset())}catch(d){d.response?n(d.response.data.message||"Subscription failed"):n("Network error. Please try again.")}finally{t.disabled=!1}}}const b=document.getElementById("scroll-top"),K=()=>{window.scrollTo({top:0,behavior:"smooth"})},j=()=>{const s=window.scrollY,t=document.querySelector("footer");if(s>window.innerHeight)if(b.classList.add("scroll-show"),t){const i=t.getBoundingClientRect();if(i.top<window.innerHeight){const e=window.innerHeight-i.top;b.style.bottom=e+200+"px"}else b.style.bottom="30px"}else b.style.bottom="30px";else b.classList.remove("scroll-show"),b.style.bottom="30px"};window.addEventListener("scroll",j);window.addEventListener("resize",j);b.addEventListener("click",K);const g="/project-17112025/assets/icons-not-min-CqnbliU1.svg";function O(s,t){const i=s.map(({filter:e,imgURL:a,name:n})=>`
      ...
      `).join("");t.innerHTML=i}function P(s,t){if(s.length>0){const e=s.map(({_id:a,name:n,target:o,bodyPart:h,burnedCalories:d,rating:q})=>`
    ...
    <div class="details">
        ...
        <span class="target-value">${o}</span>
          ...
          `).join("");t.innerHTML=e}else t.innerHTML="<p>Unfortunately, there is no content of interest to you at this time, but it will appear soon.</p>";t.querySelectorAll(".js-give-rating-btn").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.exerciseId;W(a,null)})})}function w(s,t,i){const e=Number(t),a=Number(s),n=e===1,o=e===a,h=`
  ...
  `,V=h+d+q;i.innerHTML=V}function D(s,t,i){const e=s.map(a=>`
    ...
    `,s.style.position="relative",s.appendChild(t)),t.classList.remove("hidden")}function T(s){if(!s)return;const t=s.querySelector(".local-loader-wrapper");t&&t.classList.add("hidden")}const C=["Muscles","Body parts","Equipment"],G=375,N=document.documentElement.clientWidth<=G,z=document.querySelector("span.slash"),A=document.querySelector("p.current-category"),J=document.querySelector("p.warning"),H=document.querySelector("ul.filters-list"),k=document.querySelector("ul.block-categories-list"),x=document.querySelector("ul.exercises-list"),l=document.querySelector("ul.pagination-controls-list"),E=document.querySelector("form.search-form"),U=E.querySelector(".search-input"),S=document.querySelector("button.clear-btn"),m=document.getElementById("categories-section"),X=document.querySelector("a.nav-link");X.classList.add("nav-link--active");let v=C[0],u="",f="",c=1,L=1,Q=N?9:12,r=1,p=1,R=N?8:10;E.addEventListener("input",s=>{f=s.target.value,f.length?S.classList.remove("visually-hidden"):S.classList.add("visually-hidden")});E.addEventListener("submit",async s=>{s.preventDefault(),M(m);try{const t=await B(v,u,f,r,R),{results:i,page:e,totalPages:a}=t;p=a,r=e,l.innerHTML="",P(i,x),w(p,r,l)}catch(t){y.error({icon:"",position:"topRight",message:t.message})}finally{T(m)}});S.addEventListener("click",async()=>{f="",U.value="",S.classList.add("visually-hidden"),P(results,x),w(p,r,l),I()});async function I(){k.innerHTML="",x.innerHTML="",l.innerHTML="",M(m);try{const s=await F(v,c,Q),{results:t,page:i,totalPages:e}=s;L=e,c=i,O(t,k),w(L,c,l)}catch(s){J.classList.remove("visually-hidden"),y.error({icon:"",position:"topRight",message:s.message})}finally{T(m)}}H.addEventListener("click",_);function _(s){const t=s.target.closest(".filters-list-item");t&&(v=t.dataset.option,I(),D(C,v,H),E.classList.add("visually-hidden"),f="",u="",U.value="",A.textContent=u,z.classList.add("visually-hidden"))}async function tt(s){const t=s.target.closest(".categories-item");if(t){M(m),u=t.dataset.name;try{const i=await B(v,u,f,r,R),{results:e,page:a,totalPages:n}=i;p=n,r=a,k.innerHTML="",l.innerHTML="",P(e,x),e.length>0&&(w(p,r,l),E.classList.remove("visually-hidden")),A.textContent=u,z.classList.remove("visually-hidden")}catch(i){y.error({icon:"",position:"topRight",message:i.message})}finally{T(m)}}}async function et(s){const t=s.target.closest("button[data-page]");if(t){M(m),console.log(t.dataset.page);try{if(u){switch(t.dataset.page){case"beg":r=1;break;case"prev":r--;break;case"next":r++;break;case"end":r=p;break;default:r=parseInt(t.dataset.page,10)}const i=await B(v,u,f,r,R),{results:e,page:a,totalPages:n}=i;p=n,r=a,P(e,x),w(p,r,l)}else{switch(t.dataset.page){case"beg":c=1;break;case"prev":c--;break;case"next":c++;break;case"end":c=L;break;default:c=parseInt(t.dataset.page,10)}const i=await F(v,c,Q),{results:e,page:a,totalPages:n}=i;L=n,c=a,O(e,k),w(L,c,l)}}catch(i){y.error({icon:"",position:"topRight",message:i.message})}finally{T(m)}}}D(C,v,H);I();k.addEventListener("click",tt);l.addEventListener("click",et);document.addEventListener("DOMContentLoaded",Y);
