      ...
      <div class="modal-exercise-tag-container">
        <ul class="modal-exercise-tag-list">
          ...
          <li>
            ...
            <p class="modal-exercise-tag-value">${v}</p>
          </li>
        </ul>
      </div>
