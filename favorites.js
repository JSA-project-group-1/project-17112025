import{r as m}from"./assets/quote-api-localStorage-BOl9OyTg.js";import{i as v}from"./assets/vendor-D2ogNlHo.js";const p="favorite_workouts",d=12;let a=[],s=1;function g(){const t=localStorage.getItem(p);if(!t)return[];try{const e=JSON.parse(t);return Array.isArray(e)?e:[]}catch(e){return console.error("Failed to parse favorites from LS:",e),v.error({message:"Favorites data is corrupted. Clearing storage.",position:"topRight",maxWidth:600}),localStorage.removeItem(p),[]}}function b(t){localStorage.setItem(p,JSON.stringify(t))}function h(){let t=document.querySelector("[data-favorites-list]");if(t||(t=document.getElementById("favorites-list")),t)t.classList.add("favorites-list","exercises-list");else{const e=document.querySelector("section .container");if(!e)return null;t=document.createElement("div"),t.id="favorites-list",t.classList.add("favorites-list","exercises-list"),e.appendChild(t)}return t}function y(t){const{_id:e,name:o,burnedCalories:n,time:c,bodyPart:r,target:l}=t;return`
